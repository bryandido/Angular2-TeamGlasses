...
// Change URL depending on where you're hosting it.
  getAll(){
    return this._http.get('http://localhost/teamglasses/teamglasses-api/api.php/product?&transform=1').map(res => res.json());
  }
  getById(id:number){
  ...
  postProduct(product:any){
    ...
    console.log(json);
    return this._http.post('http://localhost/teamglasses/teamglasses-api/api.php/product/', params, {headers: headers}).map(res => res.json());
  }
  delete(id: string){
